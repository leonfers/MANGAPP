    ...
    <section class="section">
      <div class="container">
        <div class="columns pd is-desktop">
          ...
          <div class="column">
            <p><strong> ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</strong></p>
          </div>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      heading: 'Manga para acalmar o coração ',
      subheading: 'Encontre amigos para dividir, vender e comprar mangas.'
    }
  }
}
</script>
